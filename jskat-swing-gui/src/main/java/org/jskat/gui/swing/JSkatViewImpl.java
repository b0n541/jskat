...
public class JSkatViewImpl implements JSkatView {
    ...
    private static void initActionMap(final MenuBar menu) {
        ...
        actions.put(JSkatAction.REPLAY_GAME_WITH_SAME_CARDS, new ReplayWithSameCardsAction());
        ...
        actions.get(JSkatAction.REPLAY_GAME_WITH_SAME_CARDS).setEnabled(false);
    ...
    private void setActions(final GameState state) {
        switch (state) {
            ...
            case GAME_OVER:
                ...
                actions.get(JSkatAction.REPLAY_GAME_WITH_SAME_CARDS).setEnabled(true);
