...
public class AIPlayerNNTest extends AbstractJSkatTest {
	...
	public void testSetDeclarerKnowCards_DeclarerNeurons() {
		...
		double[] inputs = player.setNetInputs(Card.CJ);
		assertEquals(4.0, inputs[363], 0.0);

		player.startGame(Player.MIDDLEHAND, announcement);
		inputs = player.setNetInputs(Card.CJ);
		assertEquals(4.0, inputs[0], 0.0);

		player.startGame(Player.REARHAND, announcement);
		inputs = player.setNetInputs(Card.CJ);
		assertEquals(4.0, inputs[726], 0.0);
	...
	public void testSetDeclarerKnowCards_PlayedCards() {
		...
		assertEquals(-2.0, inputs[4 + 726], 0.0);
		...
		// Club Jack for player MIDDLEHAND
		assertEquals(-4.0, inputs[2 + 363], 0.0);
		// Spade Jack for player MIDDLEHAND
	...
	public void testSetDeclarerKnowCards_PlayedCardsTwoTricks() {
		...
		double[] inputs = player.setNetInputs(Card.DJ);
		...
		assertEquals(-2.0, inputs[2 + 363], 0.0);
		...
		assertEquals(4.0, inputs[34 + 363], 0.0);
		...
		assertEquals(-4.0, inputs[38 + 363], 0.0);
	}
}
