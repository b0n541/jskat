 ...
 */
public class SaveGameAction extends AbstractJSkatAction {
	 ...
	 */
	public SaveGameAction(JSkatMaster controller, JSkatGraphicRepository bitmaps) {
		
		super(controller);
		
		putValue(Action.NAME, "Save game");
