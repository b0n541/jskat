...
public interface IJSkatPlayer {
	...
	/**
	 * This function can be used to do some finalizing calculations on the finished game
	 */
	 ...
	 * @return A bid value equal or higher as the next bid value
	 *         -1 if the player passes
	 */
	 ...
	 * When the method is done, the skat CardList must still contain exactly
	 ...
	 * @param schneiderAnnounced TRUE if schneider was announced
	 * @param schwarzAnnounced TRUE if schwarz was announced
	 */
