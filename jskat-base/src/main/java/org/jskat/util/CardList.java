...
public class CardList implements Iterable<Card> {
     ...
     *
     * @param exclude suit to exclude from calculating the most frequent suit
     ...
     * @param countJack TRUE if all of the jack should count to the number of suit
    ...
    private class SuitComparator implements Comparator<Card> {
        ...
        public int compare(Card first, Card second) {
            ...
            // trump cards follow
            if (first.getSuit() == gameType.getTrumpSuit() && second.getSuit() != gameType.getTrumpSuit()) {
                return -1;
            } else if (first.getSuit() != gameType.getTrumpSuit() && second.getSuit() == gameType.getTrumpSuit()) {
                return 1;
            } else if (first.getSuit() == gameType.getTrumpSuit() && second.getSuit() == gameType.getTrumpSuit()) {
