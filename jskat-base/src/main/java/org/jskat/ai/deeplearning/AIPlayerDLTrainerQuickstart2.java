...
//        HtmlAnalysis.createHtmlAnalysisFile(analysis, new File("/home/jan/Projects/jskat/iss/kermit_won_games_analysis.html"));
        ...
        final ComputationGraphConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .addLayer("L6", new DenseLayer.Builder().nIn(512).nOut(512).dropOut(0.6).build(), "L5")
                .addLayer("L7", new DenseLayer.Builder().nIn(512).nOut(512).dropOut(0.6).build(), "L6")
                .addLayer("L8", new DenseLayer.Builder().nIn(512).nOut(512).dropOut(0.6).build(), "L7")
                .addLayer("L9", new DenseLayer.Builder().nIn(512).nOut(256).build(), "L8")
                .addLayer("L10_multiplier", new DenseLayer.Builder().nIn(256).nOut(256).build(), "L9")
                ...
                .addLayer("L10_gametype", new DenseLayer.Builder().nIn(256).nOut(256).build(), "L9")
