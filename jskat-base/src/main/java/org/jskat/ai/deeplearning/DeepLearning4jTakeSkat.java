...
public class DeepLearning4jTakeSkat {

    public static void main(final String[] args) throws Exception {

        final FileSplit trainingData = new FileSplit(new File("/home/jan/git/jskat-multimodule/jskat-base/src/main/resources/org/jskat/ai/deeplearning/takeskat/train/"));
        final FileSplit testData = new FileSplit(new File("/home/jan/git/jskat-multimodule/jskat-base/src/main/resources/org/jskat/ai/deeplearning/takeskat/test/"));
        ...
        final MultiLayerConfiguration multiLayerConfig = new NeuralNetConfiguration.Builder()
                ...
                .list(
                        ...
                        new DenseLayer.Builder().nOut(32).build(),
                        new OutputLayer.Builder().nOut(classesCount).activation(Activation.SOFTMAX).build()
                )
        ...
        final DeepLearning4JTrainer trainer = new DeepLearning4JTrainer(
                ...
                true,
                "/home/jan/Projects/jskat/iss/kermit_won_games_analysis.html",
                transformProcess,
                finalSchema,
                classesCount,
                multiLayerConfig,
