...
public class RamschSkatProcessor {
    ...
    private static final Logger log = LoggerFactory.getLogger(RamschSkatProcessor.class);

    private static void testProcessor(final CardList cards, final CardList skat) {
        final int[] cardBin = new int[4];
        ...
        final Vector<Double> relevance = new Vector<Double>();
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            final int tmpBin = Helper.suitCardsToBinaryWithSkat(cards, skat,
                    c.getSuit());
            ...
            log.debug("Card(" + i + "): " + c + ", Rel=" + rel);
            relevance.add(Double.valueOf(rel));
        }
     ...
     * @param skat  the skat
     */
    public static void processSkat(final CardList cards, final CardList skat) {
        log.debug("\n\n================================================================");
    ...
    private static String bin(final int i, final int bits) {
    ...
    private static int findMax(final Vector<Double> list) {
        int res = 0;
        int pos = 1;
        while (list.size() > pos) {
