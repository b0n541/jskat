...
public class AnnouncementTest {
        ...
        public void testSpadesAnnouncement() {
                ...
                cards = new CardList(
                                Arrays.asList(Card.CA, Card.CT, Card.C7, Card.ST, Card.S9, Card.S8, Card.S7, Card.HA,
                ...
                cards = new CardList(
                                Arrays.asList(Card.CJ, Card.C9, Card.C7, Card.SK, Card.S9, Card.S8, Card.S7, Card.HT,
                ...
                cards = new CardList(
                                Arrays.asList(Card.DJ, Card.C7, Card.ST, Card.SK, Card.SQ, Card.S9, Card.HA, Card.HQ,
        ...
        public void testGrandAnnouncement() {
                ...
                CardList cards;
                cards = new CardList(
                                Arrays.asList(Card.SJ, Card.HJ, Card.CA, Card.SA, Card.ST, Card.SK, Card.H8, Card.DA,
                ...
                cards = new CardList(
                                Arrays.asList(Card.CJ, Card.SJ, Card.CA, Card.CT, Card.CK, Card.C9, Card.S9, Card.S8,
        ...
        public void testHeartsAnnouncement() {
                ...
                CardList cards;
                cards = new CardList(
                                Arrays.asList(Card.SJ, Card.ST, Card.SK, Card.SQ, Card.S8, Card.HQ, Card.H9, Card.H8,
                ...
                cards = new CardList(
                                Arrays.asList(Card.HJ, Card.CK, Card.C7, Card.S7, Card.HA, Card.HT, Card.HK, Card.HQ,
        ...
        public void testDiamonds() {
                ...
                CardList cards;
                cards = new CardList(
                                Arrays.asList(Card.SJ, Card.DJ, Card.DK, Card.DQ, Card.D7, Card.CA, Card.CT, Card.C9,
        ...
        public void testClubs() {
                Bidder cut;
                CardList cards;
                cards = new CardList(Arrays.asList(Card.CJ, Card.DJ, Card.CQ, Card.C9, Card.C7, Card.SA, Card.ST,
                                Card.HK, Card.HQ, Card.DA, Card.D7, Card.S9));
                cut = new Bidder(cards, Player.MIDDLEHAND);
