...
public class AlgorithmOpponentNull extends AbstractAlgorithmAI {
	private static final Logger log = Logger.getLogger(AlgorithmOpponentNull.class);
	...
	protected Card startGame() {
		System.out.println("OpponentNull starts Game: "+knowledge.getPlayerPosition());
	...
	protected Card playForehandCard() {
		System.out.println("OpponentNull plays Forehand-Card: "+knowledge.getPlayerPosition());
	...
	protected Card playMiddlehandCard() {
		System.out.println("OpponentNull plays Middlehand-Card: "+knowledge.getPlayerPosition());
	...
	protected Card playRearhandCard() {
		System.out.println("OpponentNull plays Rearhand-Card: "+knowledge.getPlayerPosition());
	...
	public CardList discardSkat(BidEvaluator bidEvaluator) {
		throw new IllegalMethodException("AlgorithmOpponentNull has nothing to discard!");
	}
