...
public class FlagTableCellRenderer extends DefaultTableCellRenderer {
	...
	private final static JSkatResourceBundle strings = JSkatResourceBundle.instance();
	...
	public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected,
		...
		Component defaultComponent = super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row,
				column);
		...
		for (char languageChar : ((String) value).toCharArray()) {
			...
			if (flag != null) {
				...
				flagLabel.setToolTipText(strings.getLanguageForFlag(flag));
