...
import org.jskat.control.action.human.ContinueSkatSeriesAction;
import org.jskat.control.action.human.DiscardAction;
import org.jskat.control.action.human.GameAnnounceAction;
import org.jskat.control.action.human.HoldBidAction;
import org.jskat.control.action.human.MakeBidAction;
import org.jskat.control.action.human.PassBidAction;
import org.jskat.control.action.human.PickUpSkatAction;
import org.jskat.control.action.human.PlayCardAction;
import org.jskat.control.action.human.PlayGrandHandAction;
import org.jskat.control.action.human.PlayHandGameAction;
import org.jskat.control.action.human.PlaySchiebeRamschAction;
import org.jskat.control.action.human.PutCardIntoSkatAction;
import org.jskat.control.action.human.SchiebenAction;
import org.jskat.control.action.human.TakeCardFromSkatAction;
import org.jskat.control.action.iss.ChangeTableSeatsAction;
import org.jskat.control.action.iss.ConnectAction;
import org.jskat.control.action.iss.CreateIssTableAction;
import org.jskat.control.action.iss.DisconnectAction;
import org.jskat.control.action.iss.InvitePlayerAction;
import org.jskat.control.action.iss.JoinIssTableAction;
import org.jskat.control.action.iss.LeaveIssTableAction;
import org.jskat.control.action.iss.ObserveTableAction;
import org.jskat.control.action.iss.OpenHomepageAction;
import org.jskat.control.action.iss.ReadyAction;
import org.jskat.control.action.iss.RegisterAction;
import org.jskat.control.action.iss.ResignAction;
import org.jskat.control.action.iss.SendChatMessageAction;
import org.jskat.control.action.iss.ShowCardsAction;
import org.jskat.control.action.iss.ShowLoginPanelAction;
import org.jskat.control.action.iss.TalkEnableAction;
import org.jskat.control.action.main.AboutAction;
import org.jskat.control.action.main.ChangeActiveTableAction;
import org.jskat.control.action.main.CreateTableAction;
import org.jskat.control.action.main.ExitAction;
import org.jskat.control.action.main.HelpAction;
import org.jskat.control.action.main.LicenseAction;
import org.jskat.control.action.main.LoadNeuralNetworksAction;
import org.jskat.control.action.main.LoadSeriesAction;
import org.jskat.control.action.main.PauseSkatSeriesAction;
import org.jskat.control.action.main.PreferencesAction;
import org.jskat.control.action.main.ResetNeuralNetworksAction;
import org.jskat.control.action.main.SaveNeuralNetworksAction;
import org.jskat.control.action.main.SaveSeriesAction;
import org.jskat.control.action.main.SaveSeriesAsAction;
import org.jskat.control.action.main.StartSkatSeriesAction;
import org.jskat.control.action.main.TrainNeuralNetworksAction;
