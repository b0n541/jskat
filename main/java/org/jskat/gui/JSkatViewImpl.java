...
public class JSkatViewImpl implements JSkatView {
	...
	private JMenuBar getMenuBar() {
		...
		// neuralNetworkMenu.add(new
		// JMenuItem(actions.get(JSkatAction.LOAD_NEURAL_NETWORKS)));
		// neuralNetworkMenu.add(new
		// JMenuItem(actions.get(JSkatAction.SAVE_NEURAL_NETWORKS)));
		// neuralNetworkMenu.add(new JSeparator());
		// neuralNetworkMenu.add(new
		// JMenuItem(actions.get(JSkatAction.RESET_NEURAL_NETWORKS)));
		// neuralNetworkMenu.add(new
		// JMenuItem(actions.get(JSkatAction.TRAIN_NEURAL_NETWORKS)));
